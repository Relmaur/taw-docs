...
- `readonly` — boolean flag that renders the field as non-interactive text instead of an editable control, for values an external process (a sync pipeline, a computed value) authoritatively owns.
