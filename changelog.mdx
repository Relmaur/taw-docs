...
<Update label="2026-07-29 (pending release)" description="taw/core: Media Folders Grid-view sidebar + vendored Alpine.js" tags={["taw-core", "taw-theme", "feature"]}>

## July 2026 — Media Folders Grid-view sidebar + vendored Alpine.js

<Callout kind="info">
  Shipped in source; not yet tagged. Version number to be assigned by the next `taw-release` run — see `taw-core` `AGENTS.md`/README for the actual `taw/core` version once cut.
</Callout>
