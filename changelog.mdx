...
<Update label="2026-07-29 (pending release)" description="taw/core: Media Folders Grid-view sidebar — drag-and-drop refinement" tags={["taw-core", "feature"]}>

## July 2026 — Grid-view sidebar: drag attachments into folders

<Callout kind="info">
  Shipped in source; not yet tagged. Version number to be assigned by the next `taw-release` run.
</Callout>
