...
<ExpandableGroup>
  ...
  <Expandable title="icon" default-open="false">
    ...
    <Callout kind="tip">
      Opt-in — call `TAW\Core\Icons\Lucide::enable()` in `inc/customizations.php` before `Theme::boot()`, or this field renders a notice instead of the picker. Full reference: `taw-core` README § "Icon System".
    </Callout>
