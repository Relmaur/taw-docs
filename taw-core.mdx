...
TAW Core registers two REST endpoints, both wired up automatically by `Theme::boot()`.

| Method | Endpoint | Purpose |
| ------ | -------- | ------- |
| `GET` | `/taw/v1/search-posts` | Post search for `post_select` fields — requires `edit_posts` capability |
| `POST` | `/taw/v1/visual-editor/save` | Save field changes from the Visual Editor — requires `edit_posts` capability |
